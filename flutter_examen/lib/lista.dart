...
import 'dart:convert';
import 'package:flutter_examen/AgregarProducto/Producto_Page.dart';
import 'package:flutter_examen/EliminarProducto/EliminarProducto.dart';
...
class _ListarProductosState extends State<ListarProductos> {
  ...
  Future getProductos() async {
    var url = 'http://192.168.0.7:80/flutter_examen/controlador/productoControler.php?op=2';
