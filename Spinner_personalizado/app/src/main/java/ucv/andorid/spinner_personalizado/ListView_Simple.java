...
public class ListView_Simple extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ListView lista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view__simple);
        ...
        androidVersionList.add("Busqueda en la Web");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch(androidVersion){
            ...
            case "Llamada": Snackbar.make(view,"Quiero Oreo",Snackbar.LENGTH_LONG).show();
                break;
            case "Busqueda en la Web":String texto="miguel";
            ...
            case "Guardar Contactos":Intent intent = new Intent(ContactsContract.Intents.Insert.ACTION);
                ...
                break;
            case "Enviar Correo": String textO="Miguel";
