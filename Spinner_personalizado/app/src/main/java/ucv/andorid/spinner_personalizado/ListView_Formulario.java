...
public class ListView_Formulario extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ListView lista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view__formulario);
        ...
        androidVersionList.add("Busqueda en Web");
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        switch(androidVersion){
            ...
            case "Llamada": Snackbar.make(view,"Quiero Oreo",Snackbar.LENGTH_LONG).show();
                break;
            case "Busqueda en Web":String texto="miguel";
